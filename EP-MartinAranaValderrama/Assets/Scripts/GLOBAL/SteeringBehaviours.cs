...
namespace AI
{
    public class BaseAgent : MonoBehaviour
    {
        ...
        public void addSeek(Vector3 target, float arriveRange = 1, float power = 1)
        {
            desiredVector += SteeringBehaviours.Seek(this, target, arriveRange) * power;
        }
    ...
    static public class SteeringBehaviours
    {
        ...
        static Vector3 Arrive(Vector3 desiredVector, float arriveRange)
        {
            ...
            else return desiredVector.normalized * (desiredVector.magnitude/arriveRange);
        }
        ...
        static Vector3 rotateVector2D(Vector3 iniV, float angle)
        {
            ...
            newV.Set(iniV.x * Mathf.Cos(angle) - iniV.z * Mathf.Sin(angle),
                     iniV.y,
                     iniV.x * Mathf.Sin(angle) + iniV.z * Mathf.Cos(angle));
            return newV;
        }
    }
